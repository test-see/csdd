...
{
    public class ListHospitalGoodsClientRequestHandler : IRequestHandler<PagerQuery<ListHospitalGoodsClientRequest>, PagerResult<ListHospitalGoodsClientResponse>>
    {
