...
{
    public class UpdateHospitalRequestHandler : IRequestHandler<UpdateHospital, Hospital>
    {
        ...
        public async Task<Hospital> Handle(IReceiveContext<UpdateHospital> context, CancellationToken cancellationToken)
        {
