...
{
    public class DeleteClientGoods2HospitalGoodsCommandHandler : ICommandHandler<DeleteClientGoods2HospitalGoodsCommand>
    {
        ...
        public async Task Handle(IReceiveContext<DeleteClientGoods2HospitalGoodsCommand> context, CancellationToken cancellationToken)
        {
