...
namespace csdd.Controllers.Shared
{
    ...
    public class DefaultControllerBase : ControllerBase
    {
        ...
        protected HospitalDepartmentValueModel HospitalDepartment => JsonConvert.DeserializeObject<HospitalDepartmentValueModel>(HttpContext.User.Claims.First(x => x.Type == "HospitalDepartmentId").Value);
